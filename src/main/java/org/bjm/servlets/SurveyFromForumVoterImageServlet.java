 ...
 * @author singh
 */
@WebServlet(name = "SurveyFromForumVoterImageServlet", urlPatterns = {"/SurveyFromForumVoterImageServlet"})
public class SurveyFromForumVoterImageServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Map<Integer, ImageVO> surveyVotersImageMap=(Map) session.getAttribute(BjmConstants.SURVEY_FROM_FORUM_VOTER_IMAGE_MAP);
